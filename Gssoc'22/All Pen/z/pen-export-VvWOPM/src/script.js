...
flap.add([
	waveSVG(document.getElementById("capeBottom1"), {
        taperEnd: 500,
        taperStart: 2,
        loose: true,
        length: 120,
	...
	waveSVG(document.getElementById("shadowBottom1"), {
        taperEnd: 80,
        taperStart: 2,
        loose: true,
        length: 120,
	...
	waveSVG(document.getElementById("shadowTop1"), {
        loose: true,
        length: 120,
        angle: -16,
        magnitude: 20,
	...
	waveSVG(document.getElementById("capeTop1"), {
        loose: true,
        angle: 70,
        length: 120,
        magnitude: 10,
...
function waveSVG(e, vars) {
    ...
    tl.to(proxy, vars.duration || 3, {
        a: Math.PI * 2,
        ease: vars.ease || Linear.easeNone,
        onUpdate: function () {
