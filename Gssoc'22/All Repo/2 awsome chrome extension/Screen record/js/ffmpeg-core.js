      ...
      function(createFFmpegCore) {
          ...
          function nb(a) {
              for (; 0 < a.length;) {
                  ...
                  if ("function" == typeof b) b(f);
                      ...
                      var c = b.uh;
                      "number" === typeof c ? void 0 === b.Sf ? H.get(c)() : H.get(c)(b.Sf) : c(void 0 === b.Sf ? null : b.Sf)
                  }
              }
          }
          ...
          function tb(a, b) {
              ...
              var c = Atomics.load(E, M.Uf >> 2),
                  d = 0;
              if (c == a && Atomics.compareExchange(E, M.Uf >> 2, c, 0) == c && (--b, d = 1, 0 >= b)) return 1;
          ...
          var M = {
              ...
              dh: function() {
                  for (; 0 <
                      M.Cg.length;) M.Cg.pop()();
                  l && threadInfoStruct && yb()
              },
              Pi: function(a) {
                  var b = pb | 0;
                  b && (Atomics.store(F, b + 4 >> 2, a), Atomics.store(F, b + 0 >> 2, 1), Atomics.store(F, b + 60 >> 2, 1), Atomics.store(F, b + 64 >> 2, 0), M.dh(), tb(b + 0, 2147483647), sb(0, 0, 0), threadInfoStruct = 0, l && postMessage({
                      cmd: "exit"
                  }))
              },
              Oi: function() {
              ...
              Ni: function() {
                  ...
                  M.Ff = [];
                  for (a = 0; a < M.Jf.length; ++a) c = M.Jf[a], b = c.xf, M.Og(b), c.terminate();
                  M.Jf = []
              },
              Og: function(a) {
                  if (a) {
              ...
              ui: function(a, b) {
                  a.onmessage = function(c) {
                      ...
                      else if ("loaded" === e) a.loaded = !0, b && b(a), a.ng && (a.ng(), delete a.ng);
                      ...
                      else if ("exit" === e) a.xf && Atomics.load(F, a.xf.Kh + 68 >> 2) && M.zg(a);
                      ...
                      } else "cancelDone" === e ? M.zg(a) : "objectTransfer" !== e && ("setimmediate" === c.data.target ? a.postMessage(c.data) : u("worker sent an unknown command " + e));
                      M.Lg = void 0
                  };
          ...
          var Yb = {
              ...
              P = {
                  ...
                  createNode: function(a, b, c, d) {
                      ...
                      O.jf(c.mode) ? (c.bf = P.Cf.dir.node, c.cf = P.Cf.dir.stream, c.af = {}) : O.isFile(c.mode) ? (c.bf = P.Cf.file.node, c.cf = P.Cf.file.stream, c.ff = 0, c.af = null) : O.Lf(c.mode) ? (c.bf = P.Cf.link.node, c.cf = P.Cf.link.stream) : O.gg(c.mode) && (c.bf = P.Cf.kh.node, c.cf = P.Cf.kh.stream);
                  ...
                  gj: function(a) {
                      return a.af ? a.af.subarray ? a.af.subarray(0,
                          a.ff) : new Uint8Array(a.af) : new Uint8Array(0)
                  },
                  rh: function(a, b) {
                      var c = a.af ? a.af.length : 0;
                      c >= b || (b = Math.max(b, c * (1048576 > c ? 2 : 1.125) >>> 0), 0 != c && (b = Math.max(b, 256)), c = a.af, a.af = new Uint8Array(b), 0 < a.ff && a.af.set(c.subarray(0, a.ff), 0))
                  },
                  Ii: function(a, b) {
                      if (a.ff != b)
                          if (0 == b) a.af = null, a.ff = 0;
                              ...
                              } else if (a.af || (a.af = []), a.af.length > b) a.af.length = b;
                              else
                                  for (; a.af.length < b;) a.af.push(0);
                              a.ff = b
                          }
                  },
                  bf: {
                      zf: function(a) {
                          ...
                          b.gid = 0;
                          b.rdev = a.rdev;
                          O.jf(a.mode) ? b.size = 4096 : O.isFile(a.mode) ? b.size = a.ff : O.Lf(a.mode) ? b.size = a.link.length : b.size = 0;
                      ...
                      rename: function(a, b, c) {
                          if (O.jf(a.mode)) {
                              ...
                              if (d)
                                  for (var e in d.af) throw new O.$e(55);
                          }
                  ...
                  cf: {
                      ...
                      write: function(a, b, c, d, e, g) {
                          ...
                          if (b.subarray && (!a.af || a.af.subarray)) {
                              ...
                              if (0 === a.ff && 0 === e) return a.af = b.slice(c, c + d), a.ff = d;
                              if (e + d <= a.ff) return a.af.set(b.subarray(c, c + d), e), d
                          }
                          P.rh(a, e + d);
                          if (a.af.subarray && b.subarray) a.af.set(b.subarray(c,
                              c + d), e);
                          else
                              for (g = 0; g < d; g++) a.af[e + g] = b[c + g];
                          a.ff = Math.max(a.ff, e + d);
                          return d
                      },
                      sf: function(a, b, c) {
                          1 === c ? b += a.position : 2 === c && O.isFile(a.node.mode) && (b += a.node.ff);
              ...
              O = {
                  ...
                  ef: function(a, b) {
                      ...
                      for (d = 0; d < a.length; d++) {
                          ...
                          if (!g || b.vf)
                              for (g =
                                  0; O.Lf(e.mode);)
                                  if (e = O.readlink(c), c = Ub(Qb(c), e), e = O.ef(c, {
                                          $g: b.$g
                                      }).node, 40 < g++) throw new O.$e(32);
                      }
                      return {
                          path: c,
                          node: e
                  ...
                  Hf: function(a) {
                      for (var b;;) {
                          if (O.vg(a)) return a = a.hf.Dh, b ? "/" !== a[a.length - 1] ? a + "/" + b : a + b : a;
                          b = b ? a.name + "/" + b : a.name;
                          a = a.parent
                      }
                  },
                  ...
                  yi: function(a, b) {
                      return a ?
                          O.Lf(a.mode) ? 32 : O.jf(a.mode) && ("r" !== O.sh(b) || b & 512) ? 31 : O.If(a, O.sh(b)) : 44
                  },
                  Ph: 4096,
                  Ai: function(a, b) {
                      b = b || O.Ph;
                  ...
                  mh: function(a, b, c) {
                      O.Gg || (O.Gg = function() {}, O.Gg.prototype = {
                          object: {
                              get: function() {
                                  return this.node
                              },
                  ...
                  Jh: function(a, b) {
                      ...
                      O.Bg++;
                      1 < O.Bg && u("warning: " +
                          O.Bg + " FS.syncfs operations in flight at once, probably just doing extra work");
                  ...
                  yj: function(a) {
                      ...
                      Object.keys(O.Bf).forEach(function(d) {
                          for (d = O.Bf[d]; d;) {
                              var e = d.Of; - 1 !== c.indexOf(d.hf) && O.Mg(d);
                              d = e
                          }
                      });
                      a.kg = null;
                  ...
                  open: function(a, b, c, d, e) {
                      ...
                      !f.logReadFiles || b & 1 || (O.Zg || (O.Zg = {}), a in O.Zg || (O.Zg[a] = 1, u("FS.trackingDelegate error on read file: " + a)));
                      try {
                          O.lf.onOpenFile && (e = 0, 1 !== (b & 2097155) && (e |= O.Lh.Fh.Qh), 0 !== (b & 2097155) && (e |= O.Lh.Fh.Rh),
                              O.lf.onOpenFile(a, e))
                      } catch (m) {
                  ...
                  Vf: function(a, b, c, d, e, g) {
                      if (0 !== (e & 2) && 0 === (g & 2) && 2 !== (a.flags & 2097155)) throw new O.$e(2);
                  ...
                  writeFile: function(a, b, c) {
                      ...
                      } else if (ArrayBuffer.isView(b)) O.write(a, b, 0, b.byteLength, void 0, c.Yh);
                  ...
                  ei: function() {
                      f.stdin ? O.Gf("/dev", "stdin", f.stdin) : O.symlink("/dev/tty",
                          "/dev/stdin");
                      f.stdout ? O.Gf("/dev", "stdout", null, f.stdout) : O.symlink("/dev/tty", "/dev/stdout");
                      f.stderr ? O.Gf("/dev", "stderr", null, f.stderr) : O.symlink("/dev/tty1", "/dev/stderr");
                      O.open("/dev/stdin", "r");
                      O.open("/dev/stdout", "w");
                      O.open("/dev/stderr", "w")
                  },
                  qh: function() {
                      O.$e || (O.$e = function(a, b) {
                          this.node = b;
                          this.Ji = function(c) {
                              this.df = c
                          };
                      ...
                      }, O.$e.prototype = Error(), O.$e.prototype.constructor = O.$e, [44].forEach(function(a) {
                          O.Pg[a] = new O.$e(a);
                  ...
                  Kg: function(a, b) {
                      ...
                      try {
                          c = O.ef(a, {
                              parent: !0
                          }), d.Bi = !0, d.Di = c.path, d.Ci = c.node, d.name = Rb(a), c = O.ef(a, {
                              vf: !b
                          }), d.exists = !0, d.path = c.path, d.object = c.node, d.name = c.node.name, d.vg = "/" === c.path
                      } catch (e) {
                          d.error = e.df
                      }
                      return d
                  ...
                  aj: function(a, b, c, d, e) {
                      ...
                      g.prototype.jh = function() {
                          ...
                          if (q || !t) p = t = 1, p = t = this.xh(0).length,
                  ...
                  cj: function(a,
                      ...
                      var w = b ? Ub(Sb(a, b)) : a;
                      eb();
                      "string" == typeof c ? ec.Wi(c, function(B) {
                          t(B)
                      }, k) : t(c)
                  },
                  indexedDB: function() {
          ...
          function kc(a, b, c, d, e) {
              ...
              try {
                  ...
                  return "undefined" !== typeof O && ua instanceof O.$e || n(ua), -ua.df
              }
          }
          ...
          function lc(a, b) {
              ...
              try {
                  ...
                  if (b & -8) var c = -28;
                      ...
                      (d = O.ef(a, {
                          vf: !0
                      }).node) ? (a = "", b & 4 && (a += "r"), b & 2 && (a += "w"), b & 1 && (a += "x"), c = a && O.If(d, a) ? -2 : 0) : c = -44
                  }
                  return c
              } catch (e) {
          ...
          function oc(a, b, c) {
              ...
              try {
                  ...
                  a = 0;
                  for (var e = O.sf(d, 0, 1), g = Math.floor(e / 280); g < d.Kf.length && a + 280 <= c;) {
                      var k = d.Kf[g];
                      if ("." === k[0]) {
                          var m = 1;
                          var r = 4
          ...
          var R = {
              ...
              pf: {
                  sg: function(a, b, c) {
                      ...
                      R.pf.ih(a, b);
                      R.pf.mi(a, b);
                      2 === a.type && "undefined" !== typeof a.Pf && b.tg.push(new Uint8Array([255,
                          255, 255, 255, 112, 111, 114, 116, (a.Pf & 65280) >> 8, a.Pf & 255
                      ]));
                      return b
                  },
                  ug: function(a, b, c) {
                  ...
                  mi: function(a, b) {
                      function c() {
                          ...
                          try {
                              for (var g = b.tg.shift(); g;) b.socket.send(g), g = b.tg.shift()
                          } catch (k) {
                              b.socket.close()
                          }
                      }
                      ...
                      function d(g) {
                          ...
                          var k =
                              e;
                          e = !1;
                          k && 10 === g.length && 255 === g[0] && 255 === g[1] && 255 === g[2] && 255 === g[3] && 112 === g[4] && 111 === g[5] && 114 === g[6] && 116 === g[7] ? (g = g[8] << 8 | g[9], R.pf.Gh(a, b), b.port = g, R.pf.ih(a, b)) : (a.$f.push({
                              gf: b.gf,
                              port: b.port,
                              data: g
                  ...
                  Yf: function(a) {
                      ...
                      if (a.$f.length || !c || c && c.socket.readyState === c.socket.CLOSING || c && c.socket.readyState === c.socket.CLOSED) b |=
                          65;
                  ...
                  Tf: function(a, b, c) {
                      switch (b) {
                          case 21531:
                              return b = 0, a.$f.length && (b = a.$f[0].data.length), E[c >> 2] = b, 0;
                          default:
                              return 28
                      }
                  },
                  ...
                  bind: function(a, b, c) {
                      if ("undefined" !== typeof a.Ag ||
                          "undefined" !== typeof a.Pf) throw new O.$e(28);
                      a.Ag = b;
                      a.Pf = c;
                      if (2 === a.type) {
                  ...
                  connect: function(a, b, c) {
                      ...
                      if ("undefined" !== typeof a.rf && "undefined" !== typeof a.uf) {
                          ...
                          if (d) {
                              if (d.socket.readyState === d.socket.CONNECTING) throw new O.$e(7);
                              throw new O.$e(30);
                          }
                      }
                      b = R.pf.sg(a, b, c);
                  ...
                  eh: function(a, b, c, d, e, g) {
                      ...
                      if (1 ===
                          a.type) {
                          if (!k || k.socket.readyState === k.socket.CLOSING || k.socket.readyState === k.socket.CLOSED) throw new O.$e(53);
                  ...
                  ah: function(a, b) {
                      ...
                      1 === a.type && b < d && (c.data = new Uint8Array(g, e + b, d - b), a.$f.unshift(c));
                      return k
                  }
              }
          };
              ...
              try {
                  ...
                  switch (a) {
                      ...
                      case 5:
                          ...
                          return t.stream.fd;
                      case 6:
                          return k = b(), q = Q(), Q(), Pc(q, k.family, Jc(k.Ag || "0.0.0.0"), k.Pf), 0;
                      case 7:
                          k = b();
                          q = Q();
                          Q();
                      ...
                      case 11:
                          ...
                          Q();
                          var p = c(!0);
                          return p ? k.nf.eh(k, y, w, B, p.gf, p.port) : O.write(k.stream, y, w, B);
                      case 12:
                          k = b();
                          var x = Q(),
                              z = Q();
                      ...
                      case 17:
                          ...
                          for (X = 0; 0 < bc && X < na; X++)
                              if ($b = E[ia + 8 * X >> 2], ac = E[ia + (8 * X + 4) >> 2]) B = Math.min(ac, bc), x = I.buffer.subarray(k, k + B), v.set(x, $b + k), k += B, bc -= B;
                          return k;
                      default:
                          return -52
                  }
              } catch (aa) {
                  return "undefined" !== typeof O && aa instanceof O.$e || n(aa), -aa.df
              }
          }
          ...
          function Fd(a, b, c) {
              ...
              if (d.Eh || !d.$i) d.Eh && (d = d.Eh), a = !1, d.qg && d.qg.pg && (a = d.qg.pg.getParameter(2978), a = 0 === a[0] && 0 === a[1] && a[2] === d.width && a[3] === d.height), d.width = b, d.height = c, a && d.qg.pg.viewport(0, 0, b, c);
              else {
                  if (d.rg) {
                      a = a ? C(a) : "";
                      d = E[d.rg + 8 >> 2];
          ...
          function Xd(a, b) {
              ...
              if (!l && M.wf == a) return u("Main thread " + a + " is attempting to join to itself!"), 16;
          ...
          var Fe = {
              ...
              F: function(a, b, c) {
                  Cd.length = 0;
                  var d;
                  for (c >>= 2; d = v[b++];)(d = 105 > d) && c & 1 && c++, Cd.push(d ? Sa[c++ >> 1] : E[c]),
                      ++c;
                      ...
                      if (a >= Zc) U(1281);
                          ...
                          if (d)
                              ...
                              if (-1 == d.ig) {
                                  ...
                                  for (b = d.ig = 0; b < e; ++b) d.ig = Math.max(d.ig, V.getActiveAttrib(a, b).name.length + 1)
                              }
                              E[c >> 2] = d.ig
                          } else if (35381 == b) {
                              if (-1 == d.jg)
                                  for (a = S[a], e = V.getProgramParameter(a, 35382), b = d.jg = 0; b < e; ++b) d.jg = Math.max(d.jg, V.getActiveUniformBlockName(a, b).length + 1);
                              E[c >> 2] = d.jg
              ...
              Xb: function(a) {
                  ...
                  for (var c = a.Mh, d = V.getProgramParameter(b, 35718), e = 0; e < d; ++e) {
              ...
              Ra: function(a) {
                  if (a === M.Oh) return u("Main thread (id=" + a + ") cannot be canceled!"), 71;
              ...
              m: function(a, b, c, d) {
                  ...
                  q = {
                      ...
                      "%V": function(p) {
                          ...
                          return 0 > k(I, z) ? "53" : 0 >= k(x, I) ? "01" : g(Math.ceil((z.getFullYear() < p.qf + 1900 ? p.Fg + 32 - z.getDate() : p.Fg + 1 - z.getDate()) / 7), 2)
                      },
                      "%w": function(p) {
                          return p.Eg
                      },
          ...
          var vc = f._memalign = function() {
              ...
              Vd = f._emscripten_get_global_libc = function() {
                  return (Vd = f._emscripten_get_global_libc = f.asm.ae).apply(null, arguments)
              };
          ...
          f._emscripten_main_browser_thread_id = function() {
              return (f._emscripten_main_browser_thread_id = f.asm.ke).apply(null, arguments)
          };
          var yb = f.___pthread_tsd_run_dtors = function() {
                  return (yb = f.___pthread_tsd_run_dtors = f.asm.le).apply(null, arguments)
              },
              Ab = f._emscripten_main_thread_process_queued_calls = function() {
                  return (Ab = f._emscripten_main_thread_process_queued_calls = f.asm.me).apply(null, arguments)
              };
          f._emscripten_current_thread_process_queued_calls = function() {
              return (f._emscripten_current_thread_process_queued_calls = f.asm.ne).apply(null, arguments)
          };
          var wb = f._emscripten_register_main_browser_thread_id = function() {
                  return (wb = f._emscripten_register_main_browser_thread_id = f.asm.oe).apply(null, arguments)
              },
              lb = f._do_emscripten_dispatch_to_thread = function() {
                  return (lb = f._do_emscripten_dispatch_to_thread = f.asm.pe).apply(null, arguments)
              };
          f._emscripten_async_run_in_main_thread = function() {
              return (f._emscripten_async_run_in_main_thread = f.asm.qe).apply(null, arguments)
          };
          f._emscripten_sync_run_in_main_thread = function() {
              return (f._emscripten_sync_run_in_main_thread = f.asm.re).apply(null, arguments)
          };
          f._emscripten_sync_run_in_main_thread_0 = function() {
              return (f._emscripten_sync_run_in_main_thread_0 = f.asm.se).apply(null, arguments)
          };
          f._emscripten_sync_run_in_main_thread_1 = function() {
              return (f._emscripten_sync_run_in_main_thread_1 = f.asm.te).apply(null, arguments)
          };
          f._emscripten_sync_run_in_main_thread_2 = function() {
              return (f._emscripten_sync_run_in_main_thread_2 = f.asm.ue).apply(null, arguments)
          };
          f._emscripten_sync_run_in_main_thread_xprintf_varargs = function() {
              return (f._emscripten_sync_run_in_main_thread_xprintf_varargs = f.asm.ve).apply(null, arguments)
          };
          f._emscripten_sync_run_in_main_thread_3 = function() {
              return (f._emscripten_sync_run_in_main_thread_3 = f.asm.we).apply(null, arguments)
          };
          var Ee = f._emscripten_sync_run_in_main_thread_4 = function() {
              return (Ee = f._emscripten_sync_run_in_main_thread_4 = f.asm.xe).apply(null, arguments)
          };
          ...
          f._emscripten_sync_run_in_main_thread_6 = function() {
              return (f._emscripten_sync_run_in_main_thread_6 = f.asm.ze).apply(null, arguments)
          };
          f._emscripten_sync_run_in_main_thread_7 = function() {
              return (f._emscripten_sync_run_in_main_thread_7 = f.asm.Ae).apply(null, arguments)
          };
          var Ad = f._emscripten_run_in_main_runtime_thread_js = function() {
                  return (Ad = f._emscripten_run_in_main_runtime_thread_js = f.asm.Be).apply(null, arguments)
              },
              Gd = f.__emscripten_call_on_thread = function() {
                  return (Gd = f.__emscripten_call_on_thread = f.asm.Ce).apply(null, arguments)
              };
