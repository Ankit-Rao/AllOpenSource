function applyStyle4Chatter(){
	...
	if(iframe[0].id==="live-chat-iframe" || iframe[0].id==='chatframe'){
		var css = "html, html *{background-color:#6fd1fed4 !important; color:rgb(22, 122, 198) !important;} #menu.yt-live-chat-text-message-renderer{background:none !important;} *::-webkit-scrollbar {width: 0px !important; background:rgba(0, 0, 0, 0.8) !important;} *::-webkit-scrollbar-thumb {background: rgba(0, 0, 0, 0.15) !important;} #input.yt-live-chat-text-input-field-renderer{background-color:#ffffff5c !important;}";
